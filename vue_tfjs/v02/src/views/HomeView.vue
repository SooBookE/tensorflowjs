<template>
  <div>
    <h2>
      특강 part2. 딥러닝 프로젝트
      <a href="https://www.tensorflow.org/js?hl=ko">tensorflowjs링크</a>
    </h2>
    <hr />
    <button @click="tfc()">console로 tfvis 체크</button>
    <button @click="e1()">예제1</button>
    <button @click="e2()">예제2</button>
    <button @click="e3()">예제3</button>
    <button @click="e4()">예제4</button>
    <button @click="e5()">예제5</button>
    <button @click="e6()">예제6</button>
    <button @click="e7()">예제7</button>
